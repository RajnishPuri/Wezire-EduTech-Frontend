        ...
        >
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea
                    ...
                    className="form-style resize-x-none min-h-[130px] w-full placeholder:text-richblack-500 border p-2 border-richblack-400 rounded text-white"
                />
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="relative">
                    <input
                        ...
                        className="form-style w-full !pl-12 placeholder:text-richblack-500 border p-2 border-richblack-400 rounded text-white"
                    />
